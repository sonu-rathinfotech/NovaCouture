 ...
 *
 * These are royalty-free stock photographs from Unsplash. They are NOT Nova
 * Couture products — they exist so the design can be judged with real
 ...
 * moment Nova Couture supplies real photography; nothing else changes, because the
...
/** True while the catalogue is showing stock photography rather than Nova Couture's. */
