...
const GST_FIELDS: { key: Key; label: string; help?: string; area?: boolean }[] = [
  ...
  { key: 'invoice_declaration', label: 'Declaration', area: true, help: 'Printed at the foot of every proforma invoice. It is what stops the document being read as a tax invoice.' },
]
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="admin-panel p-6">
          ...
          <p className="mb-4 text-sm leading-relaxed text-[var(--admin-fg-muted)]">
            Optional. The proforma invoice states no amounts, so nothing is payable against it and these do
